...
//                                Arrays.asList(PurchaseSheetContentVO.builder().pid("0000000000400000").unitPrice(BigDecimal.valueOf(1000)).quantity(10).build(),
//                                        PurchaseSheetContentVO.builder().pid("0000000000400001").unitPrice(BigDecimal.valueOf(2000)).quantity(20).build(),
//                                        PurchaseSheetContentVO.builder().pid("0000000000500000").unitPrice(BigDecimal.valueOf(3000)).quantity(30).build())
//                        )
//                        .remark("asd")
//                        .operator("lxs")
//                        .supplier(1)
//                .build());
    ...
    @Test
    void approval() {
        purchaseService.approval("JHD-20220503-00000", PurchaseSheetState.FAILURE);
    }
}